	...
	<td class="center" valign="top">
	  ...
	  <div class="main">
	    ...
	    <div style="margin-left:1em">
              <p>11/23/24: <strong>BAli-Phy 4.0-beta16</strong> is available for <a href="download.php">download</a> (See <a href="https://github.com/bredelings/BAli-Phy/blob/master/NEWS">NEWS</a>).<br/>
                <em>BAli-Phy 4.0</em> will likely be released around Mar 2025.</p>
	    ...
	    <h3><a name="intro">Introduction</a></h3>
	      ...
	      <p><b>High alignment accuracy</b>: <a href="http://mbe.oxfordjournals.org/content/31/8/1979.long">Redelings (2014)</a> showed that <em>BAli-Phy</em> had 3.5 times fewer alignment errors than MUSCLEv4 and MAFFT on simulated data:</p>
