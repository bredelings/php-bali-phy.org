	...
	<td class="center" valign="top">
	  ...
	  <h2>Examples</h2>
	    ...
	    <p>Here is a short program that infers the tree and alignment from a FASTA file given on the command line.
          ...
          <div class="roundedbox" style="border-color:#666666; margin:1em; margin-top:2em">
	    <h3><a name="M7">Tree inference under a modulated Markov model with a fixed alignment</a></h3>
	    <p>Some of the value of this framework can be seen by showing how we can do alignment inference under a more complicated substitution model.  Here we have factored the substitution model and its prior out into a function <code>gtr_m7_model</code>.  This uses a model of positive selection that (i) is based on GTR, not HKY and (ii) allows dNdS to have a Beta distribution across sites.  This is based on the Haskell that would be generated by running <b>bali-phy bglobin.fasta -S function[w,gtr+x3+dNdS[w]]+m7 --test -Inone</b>.
            </p>

              <pre><code class="haskell"><?php include('M7.hs') ?></code></pre>

                <p>You can run it as <b>bali-phy -m M7.hs --iter=1000 --- bglobin.fasta</b>.
                </p>
          </div>
