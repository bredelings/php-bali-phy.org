	...
	<td class="center" valign="top">
	  ...
	  <h2><a name="Examples">Examples</a></h2>
	    ...
	    <p>Some of the value of this framework can be seen by showing how we can do alignment inference under a more complicated substitution model.  Here we have factored the substitution model and its prior out into a function <code>gtr_m7_model</code>.</P>
            <P>This uses a model of positive selection that (i) is based on GTR, not HKY and (ii) allows dNdS to have a Beta distribution across sites.  This is based on the Haskell generated by the command <blockquote><b>bali-phy bglobin.fasta --test --smodel '|w: gtr +> x3 +> dNdS(w)| +> m7'</b></blockquote>
            </p>
	  ...
	  <p>These features have experimental status, and are expected to be stabilized by mid 2025:</p>
	  <ul>
	    <li><b>Time Trees and the relaxed clock</b>. Rooted trees implemented as a data structure within the language. </li>
            <li><b>Non-reversible markov models</b>. Non-reversible rate matrices and branch-heterogeneous models.</li>
	  </ul>
