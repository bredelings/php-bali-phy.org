	...
	<td class="center" valign="top">
	  ...
	  <h2>Examples</h2>
	    ...
	    <p>Some of the value of this framework can be seen by showing how we can do alignment inference under a more complicated substitution model.  Here we have factored the substitution model and its prior out into a function <code>gtr_m7_model</code>.</P>
            <P>This uses a model of positive selection that (i) is based on GTR, not HKY and (ii) allows dNdS to have a Beta distribution across sites.  This is based on the Haskell that would be generated by running <blockquote><b>bali-phy bglobin.fasta -S function[w,gtr+x3+dNdS[w]]+m7 --test -Inone</b></blockquote>
            </p>
